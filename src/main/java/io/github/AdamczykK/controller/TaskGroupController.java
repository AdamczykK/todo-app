...
import io.github.AdamczykK.logic.TaskGroupService;
...
public class TaskGroupController {
    ...
    String addPGroup(@ModelAttribute("group") @Valid GroupWriteModel current, BindingResult bindingResult, Model model) {
        ...
        model.addAttribute("message", "Dodano grupę do bazy!");
        return "groups";
    }
